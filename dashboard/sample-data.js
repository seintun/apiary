window.APIARY_SAMPLE_RUN = {
  "schemaVersion":"apiary.run.v1","runId":"sample","title":"Honey ComBoard sample","status":"running","privacyMode":true,"updatedAt":new Date().toISOString(),"summary":{"total":4,"queued":0,"running":1,"waiting":1,"blocked":0,"done":2,"failed":0,"canceled":0,"stale":0},
  "scouts":[
    {"id":"ux","label":"UX worker","role":"uxWorker","modelRole":"cheapWorker","model":"demo-mini","status":"done","lastSeenAt":new Date().toISOString(),"progress":100,"summary":"Designed the Honey ComBoard metaphor.","awaiting":null},
